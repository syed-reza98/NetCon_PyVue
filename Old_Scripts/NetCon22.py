...
from ttkbootstrap.constants import CENTER, W, X, PRIMARY, SUCCESS, INFO, TOP, LEFT, RIGHT, DANGER, SECONDARY, BOTH, Y
from ttkbootstrap import Style
import sqlite3
import bcrypt
from tkinter import PhotoImage
from ej import load_logs, process_transactions, merge_files, is_trial_active, read_value_from_file
...
class EJLogApp(tk.Tk):
    ...
    def setup_main_ui(self):
        self.style = Style()  # Initialize ttkbootstrap style
        self.setup_ui()
    ...
    def display_data(self):
            ...
            colors = self.style.lookup('TFrame', 'background')
    ...
    def row_selected(self, _: Any) -> None:
