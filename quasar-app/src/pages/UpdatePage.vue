          ...
          <div class="">
            <q-card-section>
              <div class="row ">
                ...
                <!-- Left Drawer -->
                <q-drawer v-model="drawer" side="left" behavior="mobile" bordered :width="300">
                  <q-scroll-area class="fit q-pa-md">
                    <div class="text-h6 q-mb-md">Upload Files</div>

                    <q-file v-model="files" label="Upload " filled multiple class="q-mb-md">
                ...
                <div class="col-md-12 col-xs-12">
                  ...
                  <div class="row items-center q-mb-md justify-between">
                    <!-- Left side: Search -->
                    <div class="col-auto">
                      <q-input rounded outlined dense debounce="300" v-model="search" placeholder="Search..."
                        input-style="color: #000000;" style="width: 900px;" color="primary" class="text-white" />
                    </div>
