...
export default defineConfig((ctx) => {
  return {
    ...
    build: {
      ...
      files: ['../dist/app.exe', '../dist/app-python.exe', '../dist/app-electron.exe'],
    ...
    sourceFiles: {
      ...
      electronMain: '../electron/electron-main',
      electronPreload: '../electron/electron-preload'
