...
class Transaction(BaseModel):
    ...
    # Financial Fields
    amount = db.Column(db.Decimal(15, 2))  # Changed from String to Decimal
    cash_dispensed = db.Column(db.Decimal(15, 2))
    cash_rejected = db.Column(db.Decimal(15, 2))
    cash_remaining = db.Column(db.Decimal(15, 2))
    ...
    __table_args__ = (
        ...
        Index('idx_transaction_file', 'file_name'),
    ...
    def has_anomaly(self):
        ...
        ] or self.total_retracted_notes > 0
...
class TransactionSummary(db.Model):
    ...
    total_amount = db.Column(db.Decimal(15, 2))
    total_dispensed = db.Column(db.Decimal(15, 2))
