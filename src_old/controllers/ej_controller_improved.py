...
from services.ej_service import EJServiceImproved
            ...
            for tx in batch:
                try:
                    ...
                    transaction = Transaction(
                        ...
                        no_notes_dispensed=_safe_int_conversion(tx.get('no_notes_dispensed')),
                        notes_dispensed_unknown=_safe_int_conversion(tx.get('notes_dispensed_unknown')),
                        ...
                        dispensed_t1=_safe_int_conversion(tx.get('dispensed_t1')),
                        dispensed_t2=_safe_int_conversion(tx.get('dispensed_t2')),
                        dispensed_t3=_safe_int_conversion(tx.get('dispensed_t3')),
                        dispensed_t4=_safe_int_conversion(tx.get('dispensed_t4')),
                        ...
                        unknown_type4=_safe_int_conversion(tx.get('UNKNOWN_TYPE4')),
                        unknown_retract=_safe_int_conversion(tx.get('UNKNOWN_RETRACT')),
                        unknown_reject=_safe_int_conversion(tx.get('UNKNOWN_REJECT')),
                        unknown_retract2=_safe_int_conversion(tx.get('UNKNOWN_RETRACT2')),
...
def get_transaction_statistics():
    ...
    try:
        ...
        recent_cutoff = datetime.utcnow() - pd.Timedelta(hours=24)
